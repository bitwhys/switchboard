...
| ADR | Status | Decision |
|---|---|---|
| [ADR-0001](0001-separate-tools-from-feedback.md) | Accepted | Separate tools from feedback and adopt the core primitives |
...
| [ADR-0006](0006-compatibility-and-plugin-distribution.md) | Accepted | Fail closed on compatibility and use explicit npm installation |
